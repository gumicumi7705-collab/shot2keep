...
import '/components/popup_s2_k_widget.dart';
...
import 'grid_view_camera_model.dart';
export 'grid_view_camera_model.dart';

class GridViewCameraWidget extends StatefulWidget {
  const GridViewCameraWidget({super.key});

  static String routeName = 'GridViewCamera';
  static String routePath = '/gridViewCamera';

  @override
  State<GridViewCameraWidget> createState() => _GridViewCameraWidgetState();
}

class _GridViewCameraWidgetState extends State<GridViewCameraWidget>
    with TickerProviderStateMixin {
  late GridViewCameraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GridViewCameraModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().isCamera) {
        ...
        if (selectedMedia != null &&
          ...
          safeSetState(() => _model.isDataUploading_uploadData2ni = true);
          ...
          try {
            ...
            _model.isDataUploading_uploadData2ni = false;
          }
          if (selectedUploadedFiles.length == selectedMedia.length) {
            safeSetState(() {
              _model.uploadedLocalFile_uploadData2ni =
        ...
        _model.addToUploadedPhotos(_model.uploadedLocalFile_uploadData2ni);
      }
    });
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final itemPhotos = _model.uploadedPhotos.toList();
                      ...
                      return Container(
                        ...
                        child: CarouselSlider.builder(
                          ...
                          itemBuilder: (context, itemPhotosIndex, _) {
                            final itemPhotosItem = itemPhotos[itemPhotosIndex];
                            return InkWell(
                          ...
                          options: CarouselOptions(
                            initialPage: max(0, min(0, itemPhotos.length - 1)),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (selectedMedia != null &&
                          ...
                          safeSetState(() =>
                              _model.isDataUploading_uploadDataNab = true);
                          var selectedUploadedFiles = <FFUploadedFile>[];
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadDataNab = false;
                          }
                          if (selectedUploadedFiles.length ==
                              selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadDataNab =
                                  selectedUploadedFiles.first;
                            });
                          } else {
                            safeSetState(() {});
                        ...
                        _model.addToUploadedPhotos(
                            _model.uploadedLocalFile_uploadDataNab);
                      },
                      text: 'Next page – new shot?',
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              height: 80.0,
                              decoration: BoxDecoration(
                                color: (FFAppState().selectedCategoryPersonal
                                        ? true
                                        : false)
                                    ? Color(0x33E2B74A)
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryPersonal
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryPersonal
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              FFAppState().selectedCategoryHome =
                                  !(FFAppState().selectedCategoryHome ?? true);
                              safeSetState(() {});
                            },
                            child: Container(
                              width: 80.0,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Opacity(
                                    opacity: FFAppState().selectedCategoryHome
                                        ? 1.0
                                        : 0.5,
                                    child: Icon(
                                      Icons.home_outlined,
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              FFAppState().selectedCategoryWork =
                                  !(FFAppState().selectedCategoryWork ?? true);
                              safeSetState(() {});
                            },
                            child: Container(
                              width: 80.0,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Opacity(
                                    opacity: FFAppState().selectedCategoryWork
                                        ? 1.0
                                        : 0.5,
                                    child: Icon(
                                      Icons.work_outline,
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryVehicle
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryVehicle
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              height: 80.0,
                              decoration: BoxDecoration(
                                color: FFAppState().selectedCategoryPurchases
                                    ? Color(0x33E2B74A)
                                    : FlutterFlowTheme.of(context).accent1,
                                borderRadius: BorderRadius.only(
                                  bottomLeft: Radius.circular(16.0),
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryPurchases
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryPurchases
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              height: 80.0,
                              decoration: BoxDecoration(
                                color: FFAppState().selectedCategoryTemporary
                                    ? Color(0x33E2B74A)
                                    : FlutterFlowTheme.of(context).accent1,
                                borderRadius: BorderRadius.only(
                                  bottomLeft: Radius.circular(16.0),
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryTemporary
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryTemporary
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryCustom1
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryCustom1
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryCustom2
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryCustom2
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryCustom3
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryCustom3
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryCustom4
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryCustom4
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryCustom5
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryCustom5
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color: FFAppState().selectedCategoryCustom6
                                      ...
                                      : FlutterFlowTheme.of(context)
                                          .secondaryText,
                                  width: FFAppState().selectedCategoryCustom6
                                      ? 3.0
                                      : 2.0,
                                ),
                              ),
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (!FFAppState()
                                        ...
                                        _model.loopOutput = await actions
                                          ...
                                          _model.uploadedPhotos.toList(),
                                          100,
                                          '.jpg',
                                        );
                                        for (int loop1Index = 0;
                                            loop1Index <
                                                _model.uploadedPhotos.length;
                                            loop1Index++) {
                                          final currentLoop1Item =
                                              _model.uploadedPhotos[loop1Index];
                                          _model.savedGalleryFilePath =
                                              await actions
                                                  .saveToGalleryUploadedFile(
                                            currentLoop1Item,
                                            'S2K-${FFAppState().counterGallerySave100000.toString()}',
                                            _model.galleryandroidPath,
                                          );
                                          FFAppState()
                                                  .counterGallerySave100000 =
                                              FFAppState()
                                                      .counterGallerySave100000 +
                                                  FFAppState().constans1;
                                        }
                                        FFAppState().galleryAndroidPath =
                                            _model.galleryandroidPath;
